...
import (
	...
	"example/test/client/client/product_repo"
)
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *ProductAPI {
	...
	cli.ProductRepo = product_repo.New(transport, formats)
	return cli
}
...
type ProductAPI struct {
	ProductRepo product_repo.ClientService
...
func (c *ProductAPI) SetTransport(transport runtime.ClientTransport) {
	...
	c.ProductRepo.SetTransport(transport)
}
